...
export default function VehiclePage({ params }: { params: { id: string } }) {
  ...
  async function handlePhotoChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      const alreadyExists = existingKeys.includes(key)
      const newKeys = alreadyExists ? existingKeys : [...existingKeys, key]
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          <button
            ...
            style={{
              ...
              border: '1px solid var(--border)',
              color: copied ? 'var(--black)' : 'var(--gray-light)',
              fontFamily: 'DM Mono, monospace',
              fontSize: 11,
              padding: '7px 14px',
              borderRadius: 4,
            ...
            {editing ? (
              <div style={{ width: '100%' }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <select
                      value={editData.make}
                      onChange={(e) => setEditData((p) => ({ ...p, make: e.target.value }))}
                      style={inputStyle}
                    >
                      {MAKES.map((m) => (
                  ...
                  <div>
                    ...
                    <input
                      value={editData.trim || ''}
                      onChange={(e) => setEditData((p) => ({ ...p, trim: e.target.value }))}
                      style={inputStyle}
                      placeholder="e.g. XLT"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setEditData((p) => ({ ...p, mileage: +e.target.value }))}
                      style={inputStyle}
                      min={0}
                      max={999999}
                    />
                  ...
                  <div>
                    ...
                    <input
                      value={editData.vin || ''}
                      onChange={(e) => setEditData((p) => ({ ...p, vin: e.target.value }))}
                      style={inputStyle}
              ...
              <>
                <div>
                  ...
                  >
                    {[vehicle.trim, vehicle.color, vehicle.mileage ? `${vehicle.mileage.toLocaleString()} mi` : null]
                      .filter(Boolean)
                      .join(' · ')}
                  </div>
            ...
            >
              ...
              >
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setEntryData((p) => ({ ...p, type: e.target.value as LogEntry['type'] }))
                    }
                    style={inputStyle}
                  >
                ...
                <div style={{ gridColumn: 'span 2' }}>
                  ...
                  <input
                    ...
                    onChange={(e) => setEntryData((p) => ({ ...p, title: e.target.value }))}
                    style={inputStyle}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setEntryData((p) => ({ ...p, cost: e.target.value }))}
                    style={inputStyle}
                    placeholder="0.00"
                    min={0}
                  />
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <textarea
                  ...
                  onChange={(e) => setEntryData((p) => ({ ...p, description: e.target.value }))}
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                <button
                  ...
                  disabled={saving || !entryData.title}
                  style={{
                    background: 'var(--accent)',
                    color: 'var(--black)',
                    border: 'none',
              ...
              {vehicle.entries.map((entry, i) => (
                ...
                >
                  <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', flex: 1 }}>
                    <span
                      className={`${badgeClass[entry.type]}`}
                      style={{
                        fontFamily: 'DM Mono, monospace',
                        fontSize: 9,
                        letterSpacing: '0.1em',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
                    <span
                      style={{
                        fontFamily: 'DM Mono, monospace',
                        fontSize: 15,
                        color: entry.cost > 0 ? 'var(--off-white)' : 'var(--gray)',
                        fontWeight: 500,
                      }}
                    >
